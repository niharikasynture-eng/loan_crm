              ...
              {([
                ...
                return (
                  <Link
                    ...
                    title={isCollapsed ? label : ''}
                    className={`flex items-center gap-3 rounded-2xl transition-all duration-200 border-2 ${isCollapsed ? 'w-12 h-12 justify-center p-0' : 'px-4 py-3'
                      } ${active
                  ...
                  >
                    ...
                    {!isCollapsed && (
                      <div className="flex items-center justify-between flex-1 min-w-0 animate-fade-in">
                        ...
                        {count > 0 && (
                          <span className={`text-xs font-bold px-2 py-0.5 rounded-full ml-2 flex-shrink-0 ${active ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-500'
                            }`}>{count}</span>
                        )}
                      </div>
                    )}
